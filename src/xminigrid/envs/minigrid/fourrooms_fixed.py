...
class FourRoomsFixed(Environment[EnvParams, EnvCarry]):
    ...
    def _generate_problem(self, params: EnvParams, key: jax.Array) -> State[EnvCarry]:
        ...
        doors_offsets = jnp.full(4, params.height // 4)
        ...
        # Goal and agent fixed positions
        goal_coords = jnp.array([8, 9])
        agent_coords = jnp.array([4, 1])
